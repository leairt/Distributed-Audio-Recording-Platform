...
public class Audiosnimak implements Serializable {
    ...
    @JoinTable(name = "vezaaudiokategorija", joinColumns = {
        @JoinColumn(name = "IdAudioSnimak", referencedColumnName = "Id")}, inverseJoinColumns = {
        @JoinColumn(name = "Kategorija", referencedColumnName = "Naziv")})
    @ManyToMany
